...
pub const GET_UPDATED_CEP18_DEPOSIT_DATA_ENTRY_POINT_NAME: &str = "get_updated_cep18_deposit_data";
...
pub const CONTRACT_OWNER_CEP18_BALANCE: &str = "contract_owner_cep18_balance";
